...
const POSTS = [
  {
    ...
    image: "/assets/base44/d24168841_image.png",
  ...
  },
  {
    ...
    image: "/assets/base44/db78ec032_image.png",
  ...
  },
  {
    ...
    image: "/assets/base44/839ca5cb0_image.png",
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {POSTS.map((post, i) => (
            <motion.a
              ...
              className="glass glass-panel glass-interactive group rounded-xl overflow-hidden transition-all duration-300"
            >
