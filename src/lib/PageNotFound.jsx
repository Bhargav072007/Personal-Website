...
export default function PageNotFound({}) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 text-foreground">
            <div className="glass glass-panel max-w-md w-full rounded-lg p-8">
                <div className="text-center space-y-6">
                    ...
                    {isFetched && authData.isAuthenticated && authData.user?.role === 'admin' && (
                        <div className="glass mt-8 p-4 rounded-lg">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="glass glass-interactive inline-flex items-center rounded-lg px-4 py-2 text-sm font-medium text-foreground"
                        >
